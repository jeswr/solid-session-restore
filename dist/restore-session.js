 ...
 */
async function refreshGrant(authorizationServer, clientRegistration, dpopHandle, refreshToken, http) {
...
export async function restoreSession(options) {
    ...
    try {
        ...
        const tokenResult = await refreshGrant(authorizationServer, clientRegistration, dpopHandle, stored.refreshToken, http);
